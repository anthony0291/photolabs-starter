...
export const FavIcon = function({
  ...
  return (
    <svg className='photo-list__fav-icon-svg' width={width} height={height} viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {
        !!displayAlert &&
        <circle cx="21" cy="4" r="2.75" fill="#00FF00" stroke="#EEEEEE" strokeWidth="0.5"/>
      }
    </svg>
  );
};
